...
12. **Protein-and-2-Ligand simulations** [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://github.com/Draavos/making-it-rain/blob/main/Protein_2_ligand_change2.ipynb)  - `Using AMBER to generate topology and to build the simulation box and for the 2 of ligand using GAFF2 force fields.`
